...
@click.option('-t', '--token', required=True, default=github_environment.get_token(), help='The Authentication token to use')
@click.option('-x', '--url', default=github_environment.get_url(), help='The URL of the Git provider to use')
